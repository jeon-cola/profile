...
import competenceJS from '../../components/competenceJS.png'
import competenceAndroid from '../../components/competenceAndroid.png'
import competenceTool from '../../components/competenceTool.png'
...
const CompetenceBox: React.FC<CompetenceBoxProps>  = ({img, title, description})=> {
  ...
  return (
    <div className="flex flex-col items-center w-[350px] gap-3 p-3">
      ...
      <h1 className="font-bold text-3xl text-left w-full">{title}</h1>


      <div className="w-full text-left text-xl text-[#A19F9F]">
        <p>{description}</p>
      </div>
