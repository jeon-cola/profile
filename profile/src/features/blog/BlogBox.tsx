...
const BlogBox:React.FC<BlogProps> = ({title, img, update, link}) => {
  ...
  return (
    <div
  className="h-[350px] w-[320px] bg-center bg-cover bg-no-repeat relative cursor-pointer hover:scale-[1.05] lg:hover:scale-[1.1] transition-all duration-300 ease-in-out"
